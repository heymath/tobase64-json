...
const Tobase64JSON = require('../index.js');

const DATA_MIME_TYPE_JPG = 'data:image/jpeg;base64,';
const DATA_MIME_TYPE_PNG = 'data:image/png;base64,';
const DATA_MIME_TYPE_GIF = 'data:image/gif;base64,';

const IMAGE_50 = '';
...
describe ('Tobase64JSON', function () {
  ...
  describe('#single file', function () {
    ...
    it ('should convert with default options', function () {
      var file = new Tobase64JSON(filePath).get();

      expect(file).to.equal(IMAGE_100_JPG);
    });
